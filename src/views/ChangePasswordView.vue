    ...
    <div class="content"> <!-- DON'T DELETE THIS DIV. ALL THE CONTENT MUST GO INSIDE -->
        <div class="wrapperRegister d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="mb-7">
                    ...
                    <button type="submit" class="btn btn-dark btn-shifty-primary"  id="btnCheck" @click="passwordCheck">Check</button>
                <div class="mb-3">
            ...
            <div id="buttonLine">
                <button type="submit" class="btn btn-dark btn-shifty-primary" id="btnUpdate" @click="update">Save</button>
